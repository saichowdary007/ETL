...
exports.RelationshipProcessor = void 0;
const stream_1 = require("stream");
class RelationshipProcessor {
    constructor() {
        this.tracker = new Map();
        this.stats = { processed: 0, invalid: 0 };
    }
    getStats() {
        return { ...this.stats };
    }
     ...
     */
    createProcessor(table, relationships, options = {}) {
        ...
        return new stream_1.Transform({
            ...
            flush(cb) {
                ...
                this.emit('integrity', self.getStats());
                cb();
            }
        });
    }
}
exports.RelationshipProcessor = RelationshipProcessor;
